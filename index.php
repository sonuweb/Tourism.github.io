...
<section class="my-5">
  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-6 col-md-6 col-12">
      <img src="images/img7.jpg " class="image-fluid aboutimg">
    </div>
    <div class="col-lg-6 col-md-6 col-12">
  ...
  <div class="card-body">
    <h4 class="card-title">Beautiful Whether</h4>
    <p class="card-text">Some example text.</p>
    <a href="#" class="btn btn-primary">See Profile</a>
      ...
      <div class="col-lg-4 col-md-4 col-12">
  <div class="card" style="width:400px" >
  <img class="card-img-top" src="images/img9.jpg" alt="Card image">
  <div class="card-body">
...
<section class="section-1">
  <div class="container text-center">
    <div class="row">
      <div class="col-md-6">
        <div class="pray">
          <img src="images/user3.jpg" alt="pray">
        </div>
      </div>
      <div class="col-md-6">
...
<section class="section-4">
  <div class="container text-center">
    <h1 class="text-dark">What Our Reader's Say About use</h1>
    <p class="text-secondarys">Lorem Ipsum dolor sit amet.</p>
  </div>
  <div class="team row">
    <div class="col-md-4 col-sm-12 text-center">
      <div class="card mr-4 d-inline-blockshadow-lg">
        <div class="card-img-top">
          <img src="images/img26.jpg" alt="Member" class="img-fluid border-radius p-4">
        </div>
        <div class="card-body">
    ...
    <div class="col-md-4 col-12 text-center">
      <div class="card mr-4 d-inline-blockshadow-lg">
        <div class="card-img-top">
          <img src="images/img25.jpg" alt="Member" class="img-fluid border-radius p-4">
        </div>
        <div class="card-body">
